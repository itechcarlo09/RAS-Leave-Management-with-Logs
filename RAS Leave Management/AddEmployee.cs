...
namespace RAS_Leave_Management
{
    public partial class AddEmployee : MaterialSkin.Controls.MaterialForm
    {
        ...
        private void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            if(txtFirstName.Text != "" && txtLastName.Text != "" && dateBirthdate.Value != null && radioMale.Checked == true || radioFemale.Checked == true && txtUsername.Text != "" && txtPassword.Text != "" && txtConfirmPassword.Text != "" && comboManager.Text != "" && radioNew.Checked == true || radioRegular.Checked == true)
            {
                ...
                if (confirm == DialogResult.Yes)
                {
                    if(txtPassword.Text == txtConfirmPassword.Text)
                    {
                        ...
                        cmd.CommandText = "INSERT INTO Account VALUES ('" + txtFirstName.Text + "','"+ txtMiddleName.Text +"','" + txtLastName.Text + "','" + dateBirthdate.Value + "','" + sex + "', '0', '"+ txtUsername.Text +"', '"+ txtConfirmPassword.Text +"', 'Employee', '1', '"+ accID +"', '"+ status +"')";
                        cmd.ExecuteNonQuery();
                        cn.Close();
                        this.Close();
                    }
